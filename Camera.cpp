...
void Camera::Update()
{
    ...
    //rotate the view vector by the horzontal angle around the vertical axis
    Vector3f View(1.0f, 0.0f, 0.0f);
    View.Rotate(m_AngleH, Yaxis);
    View.Normalize();

    //rotate the view vector byt the vertical angle around the horizontal axis
